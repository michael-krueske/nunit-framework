...
namespace NUnit.Framework.Tests.Internal
{
    ...
    {
        internal interface ITypeArgumentInferer
        {
        ...
        internal class TypeArgumentInferer : ITypeArgumentInferer
        {
            ...
            public TypeArgumentInferer(MethodInfo genericMethodDefinition)
            {
                ...
                if (genericMethodDefinition.IsGenericMethod && !genericMethodDefinition.IsGenericMethodDefinition)
        ...
        internal static ITypeArgumentInferer InferTypeArguments(this MethodInfo methodDefinition)
        {
